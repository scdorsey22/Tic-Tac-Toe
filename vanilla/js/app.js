...
function init() {
    ...
    Array.from(document.getElementsByClassName("character-image-container")).forEach((container) => {
        
        container.addEventListener("click", (event) => {
        console.log(event.currentTarget.querySelector('img').getAttribute('data-character'))
          const selectedCharacter = event.currentTarget.querySelector('img').getAttribute('data-character');
